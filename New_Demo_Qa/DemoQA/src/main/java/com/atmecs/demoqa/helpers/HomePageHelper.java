...
public class HomePageHelper {
	...
	
	{
		...
		System.out.println("in method "+productData[0][0]);
		System.out.println("in method "+productData[0][1]);
		System.out.println("in method "+productData[0][2]);
	}
	...
	public boolean isProductDiscriptionValid(WebDriver driver,String productDiscrption) {
		...
		String discription = driver.findElement(By.xpath(properties.getProperty(addProductDiscrption))).getText();
		...
		if(productDiscrption.equalsIgnoreCase(discription))
			return true;
		System.out.println("control returns from valid discription method.........................");
		return false;
